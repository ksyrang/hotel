<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html lang="ko" class="webkit chrome win  retina ratio1_25 js portrait smart"><head>
<meta http-equiv="X-UA-Compatible" content="IE=Edge">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title>STEP1 날짜&amp;인원 선택 | 객실예약 | The Shilla Hotels &amp; Resorts</title>
...
<meta name="description" content="객실예약"><!-- <meta name="keywords" content="객실예약, 패키지예약, 객실&패키지예약, 호텔예약, 고급호텔예약, 신라호텔예약, 서울신라호텔예약, Deluxe, Business Deluxe, Executive Business Deluxe, Executive Grand Deluxe, Lounge, Superior, Korean, Corner, Premier, Royal, Shilla, Presidential" /> -->
<meta name="og:title" content="STEP1 날짜&amp;인원 선택 | 객실예약 | The Shilla Hotels &amp; Resorts">
<!-- 검색엔진용 추가 180524 -->
...
<script type="text/javascript" async="" src="https://www.google-analytics.com/analytics.js"></script>
<script async="" src="https://www.googletagmanager.com/gtm.js?id=GTM-T3LBJ26"></script><script type="text/javascript">
...
function popCalendarLayer(dateId , today){
	...
	if(today != '2022-05-26'){
		today = today.split("-");
		var originToday = "2022-05-26".split("-");
...
</script><meta http-equiv="origin-trial" content=""><meta http-equiv="origin-trial" content=""><script src="https://www.googleadservices.com/pagead/conversion/412555315/?random=1653545506843&amp;cv=9&amp;fst=1653545506843&amp;num=1&amp;value=1&amp;currency_code=KRW&amp;label=DOucCPG18fcBELOw3MQB&amp;bg=ffffff&amp;guid=ON&amp;resp=GooglemKTybQhCsO&amp;u_h=864&amp;u_w=1536&amp;u_ah=824&amp;u_aw=1536&amp;u_cd=24&amp;u_his=10&amp;u_tz=540&amp;u_java=false&amp;u_nplug=5&amp;u_nmime=2&amp;gtm=2wg5n0&amp;sendb=1&amp;ig=1&amp;frm=0&amp;url=https%3A%2F%2Fwww.shillahotels.com%2Fseoul%2Fresv%2Frpm%2FmemSetStep1.do&amp;ref=https%3A%2F%2Fwww.shillahotels.com%2Findex.do&amp;tiba=STEP1%20%EB%82%A0%EC%A7%9C%26%EC%9D%B8%EC%9B%90%20%EC%84%A0%ED%83%9D%20%7C%20%EA%B0%9D%EC%8B%A4%EC%98%88%EC%95%BD%20%7C%20The%20Shilla%20Hotels%20%26%20Resorts&amp;auid=639288525.1653361753&amp;hn=www.googleadservices.com&amp;bttype=purchase&amp;async=1&amp;rfmt=3&amp;fmt=4"></script>
</head>
...
<div class="subWrap subWrapHub">
	...
	function ssoLogout() {
		location.href = "/seoul/login/SSOLogout.do";
				...
				success : function(json){
					...
					for(var c = 0;c < hotlList.length; c++){
						...
						if(hotlObj.resvPosbAheadDyCnt != "0"){
							aheadDayYnTF = fnResvPosbAheadDyYnTF(hotlObj.resvPosbAheadDyCnt, '2022-05-26');
							if(!aheadDayYnTF){
								switch (lang) {
								...
								$.ajax({
									...
									success : function(data){
										...
										if(keywordList.length > 1){
											...
											tabHtml += "				<strong class=\"tit\"><img src=\"${pageContext.request.contextPath}/images/ko/mem/new_2019/tit_rsv_keyword.gif\" alt=\"키워드 검색\"></strong>"; 
											...
											tabHtml += "				<img src=\"${pageContext.request.contextPath}/images/ko/mem/new_2019/btn_hotel_clear_txt.png\" alt=\"선택해제\">"; 
											tabHtml += "			</a>";
											tabHtml += "		</span>";
											tabHtml += "		<a href=\"#none\" class=\"btnKeySrch\" onclick=\"fncSearchResvList('N');\"><img src=\"${pageContext.request.contextPath}/images/ko/mem/new_2019/reserve_step1_keyword.gif\" alt=\"적용\"></a>"; 
											tabHtml += "		</div>";
											tabHtml += "	</div>";
											tabHtml += "</li>";
										}else{
										...
										if(roomCnt > 0){
										 	...
										 	for(var i = 0; i < roomList.length; i++){
												...
												roomHtml += "							<span class=\"days\">1"+bak+"</span>";
										 		...
										 		roomHtml += "					</div>";
										 		roomHtml += "				</div>";
										 		roomHtml += "				<a href=\"#none\" class=\"btnRsv\"><img src=\"${pageContext.request.contextPath}/images/ko/mem/new_2019/reserve_step1_rsvopen.gif\" alt=\"예약하기\" onclick=\"setRoomOpt('"+i+"','"+roomObj.roomClsCd+"', '"+roomObj.roomCd+"', '"+roomObj.ratePlanCode+"', '"+roomObj.infantResvYn+"','"+domain+objData[imgSrcKey]+"', 'KR', 'ko');\"></a>";
										...
										if(packList.length > 0){
											...
											for(var j = 0; j < packList.length; j++){
												...
												packHtml += "					<img src=\"${pageContext.request.contextPath}/images/ko/mem/new_2019/img_badge_rewards.png\" alt=\"추가혜택\">";
												packHtml += "				</div>";
												}
												...
												packHtml += "						</div>";
												packHtml += "					</div>";
												packHtml += "					<a href=\"#none\" class=\"btnRsv\"><img src=\"${pageContext.request.contextPath}/images/ko/mem/new_2019/reserve_step1_rsvopen.gif\" alt=\"예약하기\" onclick=\"setPackOptEx('P','"+j+"', '"+packObj.spofrId+"', '"+packObj.packItNo+"', '"+packObj.ratePlanCode+"', '"+packObj.infantResvYn+"', '"+packObj.spcFeeYn+"', '"+packObj.rewardsMappingYn+"','"+packObj.rewardsMappingId+"','"+packObj.rewardsMappingListDc+"','"+packObj.rewardsMappingUrl+"');\"></a>";
										...
										if(mbrPackList.length > 0){
											...
											for(var j = 0; j < mbrPackList.length; j++){
												...
												mbrPackHtml += "				<a href=\"#none\" class=\"btnRsv\"><img src=\"${pageContext.request.contextPath}/images/ko/mem/new_2019/reserve_step1_rsvopen.gif\" alt=\"예약하기\" onclick=\"setPackOptEx('M','"+j+"', '"+mbrObj.spofrId+"', '"+mbrObj.packItNo+"', '"+mbrObj.ratePlanCode+"', '"+mbrObj.infantResvYn+"', '"+mbrObj.spcFeeYn+"', '', '', '');\"></a>";
			...
			if($("#related_"+roomIdx+"_"+bedSeq).find(".slideBox").length == 0 ){
				...
				$.ajax({
					...
					success : function(json){
						...
						var dong = "&nbsp;VND";
						var relationHtml = "";
						relationHtml += "<strong class=\"tit\"><img src=\"${pageContext.request.contextPath}/images/ko/mem/new_2019/tit_roomrelation.png\" alt=\"객실 연관 상품\"></strong>";
				...
				success : function(html){
					...
					if(resultCd == "00"){
						...
						if(jsonObj.model.roomViewCdList.length > 0){
							...
							if($("#hotlId").val() == "S" || $("#hotlId").val() == "C"){
								if (fnTaxTF()){
									$("#totlO .txtTotal2 img").attr("src", "${pageContext.request.contextPath}/images/ko/mem/new_2019/tit_est_totalprice3.png");
									totPricHtml += "<p class=\"vatTxt\">* 부가가치세 10% 및 봉사료 10%(합계 21%)가 포함된 금액입니다.</p>";
								}else{
									$("#totlO .txtTotal2 img").attr("src", "${pageContext.request.contextPath}/images/ko/mem/new_2019/tit_est_totalprice4.png");
...
<input type="hidden" id="srvTime" name="srvTime" value="2022-4-26-15" autocomplete="off">
		...
		<div class="new_rsvBox">
				...
				<div class="cpRoomProd" id="cpCls2">
					<div class="cpRoomCon">
						...
						<div class="btnCpBox disabled" id="cpPopBtn">
							<a href="#none" onclick="openComparePop();"><img src="${pageContext.request.contextPath}/images/ko/mem/new_2019/btn_compare.png" alt="비교하기"></a>
			...
			<div class="rsvStepWrap">
				<div class="rsvStepList step1">
					<ul>
						<li class="step1 first"><span>현재단계</span><img src="${pageContext.request.contextPath}/images/ko/mem/new_2019/rsv_step1_on.png" alt="Step1. 호텔, 날짜, 인원 선택"></li>
						<li class="step2"><img src="${pageContext.request.contextPath}/images/ko/mem/new_2019/rsv_step2_on.png" alt="Step2. 옵션 선택"></li>
						<li class="step3 last"><img src="${pageContext.request.contextPath}/images/ko/mem/new_2019/rsv_step3_on.png" alt="Step3. 고객 정보 입력"></li>
					</ul>
				</div>
          </div>
	...
	<div class="rsvWrap">
			<div class="rsvSchHotel">
          		<div class="rsvSchCont htSch">
          			<dl>
          				<dt class=""><img src="${pageContext.request.contextPath}/images/ko/mem/new_2019/tit_searchhotel01.png" alt="도시 또는 호텔"></dt>
          				<dd class="htSchWrap">
          		...
          		<div class="rsvSchCont htCheck">
          			<dl>
          				<dt><img src="${pageContext.request.contextPath}/images/ko/mem/new_2019/tit_searchhotel02.png" alt="체크인"></dt>
          				<dd><a href="#none" class="btnCalShow" id="ckinDateInfo" tabindex="0">2022.05.26 (목)</a></dd>
          				<input type="hidden" name="ckinYmd" id="ckinYmd" title="체크인 날짜 입력" value="2022-05-26" autocomplete="off">
          			</dl>
          			<dl class="stay">
          			...
          			<dl>
          				<dt><img src="${pageContext.request.contextPath}/images/ko/mem/new_2019/tit_searchhotel03.png" alt="체크아웃"></dt>
          				<dd><a href="#none" class="btnCalShow" id="ckoutDateInfo">2022.05.27 (금)</a></dd>
          				<input type="hidden" name="ckoutYmd" id="ckoutYmd" title="체크아웃 날짜 입력" value="2022-05-27" autocomplete="off">
          			</dl>
          		</div>
          		<div class="rsvSchCont htRoom">
          			<dl>
          				<dt><img src="${pageContext.request.contextPath}/images/ko/mem/new_2019/tit_searchhotel04.png" alt="객실"></dt>
          				<dd><a href="#none" class="btnRoomshow" id="roomCntTxt">1</a></dd>
         				<input type="hidden" name="roomCnt" id="roomCnt" value="1" autocomplete="off" >
          			</dl>
          			<dl>
          				<dt><img src="${pageContext.request.contextPath}/images/ko/mem/new_2019/tit_searchhotel05.png" alt="성인"></dt>
          				<dd><a href="#none" class="btnRoomshow" id="totlAdltCntTxt">2</a></dd>
          			</dl>
          			<dl>
          				<dt>
          					<img src="${pageContext.request.contextPath}/images/ko/mem/new_2019/tit_searchhotel06.png" alt="어린이">
          			...
          			<dl>
          				<dt>
          					<img src="${pageContext.request.contextPath}/images/ko/mem/new_2019/tit_searchhotel07.png" alt="유아">
          					<span class="btnQuestion">
          						<strong class="hidden">안내</strong>
          		...
          		<div class="rsvSchCont btnSearch">
          			<a href="#none"><img src="${pageContext.request.contextPath}/images/ko/mem/new_2019/btn_search.gif" alt="검색" onclick="fncSearchResvList('N');"></a>	          				
	          			</div>
			</div>
		            <div class="ly_reserve htSearch" style="display: none;"> 
		              <div class="htBoxTop">
		              	<ul class="htTab clearfix">
		              		<li class="tab2 first on"><a href="#none"><span>권역별</span></a></li>
		              		<li class="tab1 last"><a href="#none"><span>브랜드별</span></a></li>
		              	</ul>
		              	<p class="noti2"><img src="${pageContext.request.contextPath}/images/ko/mem/new_2019/txt_hotel_seach_noti.png" alt="※ 최대 5개까지 선택 가능"></p>
	              	</div>
	              	<div class="htBox" style="display:block">
			              	...
			              	<div class="htBoxResult">
				              	<div class="scroll">
				              		<div class="scrollCont" id="htBoxInfo">
						                ...
						                <div class="noData" style="display:none;"><p>검색 결과가 없습니다.<br>다른 키워드를 선택해주세요.</p></div>
						                <div class="htTabCon" style="display:block;" id="htRegionList">
												<strong class="hidden">권역별 검색결과</strong>
						              			<div class="htData ckType" data-maxselcnt="5"><strong class="contury">국내</strong><dl>	<dt>서울 강북</dt>	<dd>		<ul><li data-hotlid="S" data-hoteltitle="서울신라호텔" data-addr="서울특별시 중구 장충동 동호로 249<br>(우 : 04605)" data-imgurl="https://www.shilla.net//images/upload/spofrpack/191125/FILEafd876ae8bd11949.jpg"><a href="#none">서울신라호텔</a></li><li data-hotlid="GHMSS" data-hoteltitle="신라스테이 광화문" data-addr="서울특별시 종로구 삼봉로 71<br>(우 : 03150)" data-imgurl="https://www.shilla.net//images/upload/spofrpack/191125/FILE4b37ece45ff6ff30.jpg"><a href="#none">신라스테이 광화문</a></li><li data-hotlid="MAPSS" data-hoteltitle="신라스테이 마포" data-addr="서울특별시 마포구 마포대로 83<br>(우 : 04156)" data-imgurl="https://www.shilla.net//images/upload/spofrpack/191125/FILEb17e753bd928b42c.jpg"><a href="#none">신라스테이 마포</a></li><li data-hotlid="SDMSS" data-hoteltitle="신라스테이 서대문" data-addr="서울특별시 서대문구 충정로 76<br>(우 : 03738)" data-imgurl="https://www.shilla.net//images/upload/spofrpack/191125/FILEb6d9aae60babd074.jpg"><a href="#none">신라스테이 서대문</a></li>	</ul>	</dd></dl><dl>	<dt>서울 강남</dt>	<dd>		<ul><li data-hotlid="YEOSS1" data-hoteltitle="신라스테이 역삼" data-addr="서울특별시 강남구 언주로 517<br>(우 : 06139)" data-imgurl="https://www.shilla.net//images/upload/spofrpack/191125/FILE6c205ba0dfaa3840.jpg"><a href="#none">신라스테이 역삼</a></li><li data-hotlid="SCHSS" data-hoteltitle="신라스테이 서초" data-addr="서울특별시 서초구 효령로 427<br>(우 : 06628)" data-imgurl="https://www.shilla.net//images/upload/spofrpack/191125/FILEadd4692694d6058.jpg"><a href="#none">신라스테이 서초</a></li><li data-hotlid="GURSS" data-hoteltitle="신라스테이 구로" data-addr="서울특별시 동작구 시흥대로 596<br>(우: 07074)" data-imgurl="https://www.shilla.net//images/upload/spofrpack/191125/FILE9804827bb3e6d478.jpg"><a href="#none">신라스테이 구로</a></li><li data-hotlid="SAMSS" data-hoteltitle="신라스테이 삼성" data-addr="서울특별시 영동대로 506<br>(우 : 06173)" data-imgurl="https://www.shilla.net//images/upload/spofrpack/200417/FILE855bdee66122b85f.jpg"><a href="#none">신라스테이 삼성</a></li>	</ul>	</dd></dl><dl>	<dt>전국</dt>	<dd>		<ul><li data-hotlid="C" data-hoteltitle="제주신라호텔" data-addr="제주특별자치도 서귀포시 색달동 중문관광로72번길 75<br>(우 : 63535)" data-imgurl="https://www.shilla.net//images/upload/spofrpack/191125/FILE2ebee8d30d2367.jpg"><a href="#none">제주신라호텔</a></li><li data-hotlid="D" data-hoteltitle="신라스테이 동탄" data-addr="경기도 화성시 노작로 161<br>(우 : 18454)" data-imgurl="https://www.shilla.net//images/upload/spofrpack/191125/FILEb8b7b9d55663afd7.jpg"><a href="#none">신라스테이 동탄</a></li><li data-hotlid="CHASS" data-hoteltitle="신라스테이 천안" data-addr="충청남도 천안시 서북구 동서대로 177<br>(우 : 31110)" data-imgurl="https://www.shilla.net//images/upload/spofrpack/191125/FILE41b0ec043ec9a39b.jpg"><a href="#none">신라스테이 천안</a></li><li data-hotlid="ULSSS" data-hoteltitle="신라스테이 울산" data-addr="울산광역시 남구 삼산로 200<br>(우 : 44718)" data-imgurl="https://www.shilla.net//images/upload/spofrpack/191125/FILE61edff3f57b63b2f.jpg"><a href="#none">신라스테이 울산</a></li><li data-hotlid="HUDSS" data-hoteltitle="신라스테이 해운대" data-addr="부산광역시 해운대구 해운대로570번길 46<br>(우 : 48093)" data-imgurl="https://www.shilla.net//images/upload/spofrpack/191125/FILE73c17a7a85da79d0.jpg"><a href="#none">신라스테이 해운대</a></li><li data-hotlid="SBSSS" data-hoteltitle="신라스테이 서부산" data-addr="부산광역시 강서구 명지국제7로 38<br>(우 : 46726)" data-imgurl="https://www.shilla.net//images/upload/spofrpack/210311/FILEd985a903ff9e1baf.jpg"><a href="#none">신라스테이 서부산</a></li><li data-hotlid="JEJSS" data-hoteltitle="신라스테이 제주" data-addr="제주특별자치도 제주시 노연로 100<br>(우 : 63133)" data-imgurl="https://www.shilla.net//images/upload/spofrpack/191125/FILEb06ff7114282f5bd.jpg"><a href="#none">신라스테이 제주</a></li>	</ul>	</dd></dl><strong class="contury">해외</strong><dl>	<dt>베트남</dt>	<dd>		<ul><li data-hotlid="VDNSM" data-hoteltitle="신라모노그램 다낭" data-addr="Lac Long Quan, Dien Ngoc, Dien Ban District, Quang Nam Province, Vietnam" data-imgurl="https://www.shilla.net//images/upload/spofrpack/200211/FILEf131cac073c2770e.jpg"><a href="#none">신라모노그램 다낭</a></li>	</ul>	</dd></dl></div>
									      </div>
					              		<div class="htTabCon" style="display:none;" id="htBrandList">
						              		<strong class="hidden">브랜드별 검색결과</strong>	
								              <div class="htData ckType" data-maxselcnt="5"><dl>	<dt>신라호텔</dt>	<dd>		<ul><li data-hotlid="S" data-hoteltitle="서울신라호텔" data-addr="서울특별시 중구 장충동 동호로 249<br>(우 : 04605)" data-imgurl="https://www.shilla.net//images/upload/spofrpack/191125/FILEafd876ae8bd11949.jpg"><a href="#none">서울신라호텔</a></li><li data-hotlid="C" data-hoteltitle="제주신라호텔" data-addr="제주특별자치도 서귀포시 색달동 중문관광로72번길 75<br>(우 : 63535)" data-imgurl="https://www.shilla.net//images/upload/spofrpack/191125/FILE2ebee8d30d2367.jpg"><a href="#none">제주신라호텔</a></li>	</ul>	</dd></dl><dl>	<dt>신라모노그램</dt>	<dd>		<ul><li data-hotlid="VDNSM" data-hoteltitle="신라모노그램 다낭" data-addr="Lac Long Quan, Dien Ngoc, Dien Ban District, Quang Nam Province, Vietnam" data-imgurl="https://www.shilla.net//images/upload/spofrpack/200211/FILEf131cac073c2770e.jpg"><a href="#none">신라모노그램 다낭</a></li>	</ul>	</dd></dl><dl>	<dt>신라스테이</dt>	<dd>		<ul><li data-hotlid="GHMSS" data-hoteltitle="신라스테이 광화문" data-addr="서울특별시 종로구 삼봉로 71<br>(우 : 03150)" data-imgurl="https://www.shilla.net//images/upload/spofrpack/191125/FILE4b37ece45ff6ff30.jpg"><a href="#none">신라스테이 광화문</a></li><li data-hotlid="MAPSS" data-hoteltitle="신라스테이 마포" data-addr="서울특별시 마포구 마포대로 83<br>(우 : 04156)" data-imgurl="https://www.shilla.net//images/upload/spofrpack/191125/FILEb17e753bd928b42c.jpg"><a href="#none">신라스테이 마포</a></li><li data-hotlid="SDMSS" data-hoteltitle="신라스테이 서대문" data-addr="서울특별시 서대문구 충정로 76<br>(우 : 03738)" data-imgurl="https://www.shilla.net//images/upload/spofrpack/191125/FILEb6d9aae60babd074.jpg"><a href="#none">신라스테이 서대문</a></li><li data-hotlid="YEOSS1" data-hoteltitle="신라스테이 역삼" data-addr="서울특별시 강남구 언주로 517<br>(우 : 06139)" data-imgurl="https://www.shilla.net//images/upload/spofrpack/191125/FILE6c205ba0dfaa3840.jpg"><a href="#none">신라스테이 역삼</a></li><li data-hotlid="SCHSS" data-hoteltitle="신라스테이 서초" data-addr="서울특별시 서초구 효령로 427<br>(우 : 06628)" data-imgurl="https://www.shilla.net//images/upload/spofrpack/191125/FILEadd4692694d6058.jpg"><a href="#none">신라스테이 서초</a></li><li data-hotlid="GURSS" data-hoteltitle="신라스테이 구로" data-addr="서울특별시 동작구 시흥대로 596<br>(우: 07074)" data-imgurl="https://www.shilla.net//images/upload/spofrpack/191125/FILE9804827bb3e6d478.jpg"><a href="#none">신라스테이 구로</a></li><li data-hotlid="SAMSS" data-hoteltitle="신라스테이 삼성" data-addr="서울특별시 영동대로 506<br>(우 : 06173)" data-imgurl="https://www.shilla.net//images/upload/spofrpack/200417/FILE855bdee66122b85f.jpg"><a href="#none">신라스테이 삼성</a></li><li data-hotlid="D" data-hoteltitle="신라스테이 동탄" data-addr="경기도 화성시 노작로 161<br>(우 : 18454)" data-imgurl="https://www.shilla.net//images/upload/spofrpack/191125/FILEb8b7b9d55663afd7.jpg"><a href="#none">신라스테이 동탄</a></li><li data-hotlid="CHASS" data-hoteltitle="신라스테이 천안" data-addr="충청남도 천안시 서북구 동서대로 177<br>(우 : 31110)" data-imgurl="https://www.shilla.net//images/upload/spofrpack/191125/FILE41b0ec043ec9a39b.jpg"><a href="#none">신라스테이 천안</a></li><li data-hotlid="ULSSS" data-hoteltitle="신라스테이 울산" data-addr="울산광역시 남구 삼산로 200<br>(우 : 44718)" data-imgurl="https://www.shilla.net//images/upload/spofrpack/191125/FILE61edff3f57b63b2f.jpg"><a href="#none">신라스테이 울산</a></li><li data-hotlid="HUDSS" data-hoteltitle="신라스테이 해운대" data-addr="부산광역시 해운대구 해운대로570번길 46<br>(우 : 48093)" data-imgurl="https://www.shilla.net//images/upload/spofrpack/191125/FILE73c17a7a85da79d0.jpg"><a href="#none">신라스테이 해운대</a></li><li data-hotlid="SBSSS" data-hoteltitle="신라스테이 서부산" data-addr="부산광역시 강서구 명지국제7로 38<br>(우 : 46726)" data-imgurl="https://www.shilla.net//images/upload/spofrpack/210311/FILEd985a903ff9e1baf.jpg"><a href="#none">신라스테이 서부산</a></li><li data-hotlid="JEJSS" data-hoteltitle="신라스테이 제주" data-addr="제주특별자치도 제주시 노연로 100<br>(우 : 63133)" data-imgurl="https://www.shilla.net//images/upload/spofrpack/191125/FILEb06ff7114282f5bd.jpg"><a href="#none">신라스테이 제주</a></li>	</ul>	</dd></dl></div>
									    </div>
						              </div>
						             </div>
					            </div>
			              ...
			              <div class="ckHotelInfo">									
	               		 ...
	               		 <a href="#none" class="btnClear" style="display:block;"><img src="${pageContext.request.contextPath}/images/ko/mem/new_2019/btn_hotel_clear_txt.png" alt="선택해제" onclick="keywordClear('ko');"></a>
						<div class="btnList">
			    			<a href="#none" class="" id=""><img src="${pageContext.request.contextPath}/images/ko/mem/new_2019/reserve_step1_ok_disable.gif" alt="확인" id="keywordAreaBtn"></a>
	           			</div>
		            </div>
					<div class="ly_reserve rsvCalendarDate new_rsvCal" id="rsvCalendarDate" tabindex="0"><div class="calendarRsvBox"><a class="btnPrevDisable" href="javascript:;">	<span>Prev</span></a><div class="calendarReserve calendarPrev"><div class="datePrev"><span class="calYear">2022.</span>5</div>    <table summary="일,월,화,수,목,금,토 로 구성된 게시물 리스트">      <caption>2022.5 달력입니다.</caption>      <thead>        <tr>          <th class="sun" scope="col"><span>일</span></th>          <th class="mon" scope="col"><span>월</span></th>          <th class="tue" scope="col"><span>화</span></th>          <th class="wed" scope="col"><span>수</span></th>          <th class="thu" scope="col"><span>목</span></th>          <th class="fri" scope="col"><span>금</span></th>          <th class="sat" scope="col"><span>토</span></th>        </tr>      </thead>      <tbody>        <tr class="first"><td class="sun"><span id="2022-05-01" class="rNoDate" title="예약불가일자"><a>1</a></span></td><td><span id="2022-05-02" class="rNoDate" title="예약불가일자"><a>2</a></span></td><td><span id="2022-05-03" class="rNoDate" title="예약불가일자"><a>3</a></span></td><td><span id="2022-05-04" class="rNoDate" title="예약불가일자"><a>4</a></span></td><td><span id="2022-05-05" class="rNoDate" title="예약불가일자"><a>5</a></span></td><td><span id="2022-05-06" class="rNoDate" title="예약불가일자"><a>6</a></span></td><td class="sat"><span id="2022-05-07" class="rNoDate" title="예약불가일자"><a>7</a></span></td>        </tr>        <tr><td class="sun"><span id="2022-05-08" class="rNoDate" title="예약불가일자"><a>8</a></span></td><td><span id="2022-05-09" class="rNoDate" title="예약불가일자"><a>9</a></span></td><td><span id="2022-05-10" class="rNoDate" title="예약불가일자"><a>10</a></span></td><td><span id="2022-05-11" class="rNoDate" title="예약불가일자"><a>11</a></span></td><td><span id="2022-05-12" class="rNoDate" title="예약불가일자"><a>12</a></span></td><td><span id="2022-05-13" class="rNoDate" title="예약불가일자"><a>13</a></span></td><td class="sat"><span id="2022-05-14" class="rNoDate" title="예약불가일자"><a>14</a></span></td>        </tr>        <tr><td class="sun"><span id="2022-05-15" class="rNoDate" title="예약불가일자"><a>15</a></span></td><td><span id="2022-05-16" class="rNoDate" title="예약불가일자"><a>16</a></span></td><td><span id="2022-05-17" class="rNoDate" title="예약불가일자"><a>17</a></span></td><td><span id="2022-05-18" class="rNoDate" title="예약불가일자"><a>18</a></span></td><td><span id="2022-05-19" class="rNoDate" title="예약불가일자"><a>19</a></span></td><td><span id="2022-05-20" class="rNoDate" title="예약불가일자"><a>20</a></span></td><td class="sat"><span id="2022-05-21" class="rNoDate" title="예약불가일자"><a>21</a></span></td>        </tr>        <tr><td class="sun"><span id="2022-05-22" class="rNoDate" title="예약불가일자"><a>22</a></span></td><td><span id="2022-05-23" class="rNoDate" title="예약불가일자"><a>23</a></span></td><td><span id="2022-05-24" class="rNoDate" title="예약불가일자"><a>24</a></span></td><td><span id="2022-05-25" class="rNoDate" title="예약불가일자"><a>25</a></span></td><td><span id="2022-05-26" class="rDate selDate sd_first today" title="today"><span class="tTxt">오늘</span><a href="javascript:;">26</a></span></td><td><span id="2022-05-27" class="rDate selDate sd_last" title="예약가능일자"><a href="javascript:;">27</a></span></td><td class="sat"><span id="2022-05-28" class="rDate" title="예약가능일자"><a href="javascript:;">28</a></span></td>        </tr>        <tr><td class="sun"><span id="2022-05-29" class="rDate" title="예약가능일자"><a href="javascript:;">29</a></span></td><td><span id="2022-05-30" class="rDate" title="예약가능일자"><a href="javascript:;">30</a></span></td><td><span id="2022-05-31" class="rDate" title="예약가능일자"><a href="javascript:;">31</a></span></td><td><span>&nbsp;</span></td><td><span>&nbsp;</span></td><td><span>&nbsp;</span></td><td class="sat"><span>&nbsp;</span></td>        </tr>        <tr class="last"><td class="sun"><span>&nbsp;</span></td><td><span>&nbsp;</span></td><td><span>&nbsp;</span></td><td><span>&nbsp;</span></td><td><span>&nbsp;</span></td><td><span>&nbsp;</span></td><td class="sat"><span>&nbsp;</span></td>        </tr>      </tbody>    </table><span class="tip" style="display: none;"></span></div><div class="calendarReserve calendarNext"><div class="datePrev"><span class="calYear">2022.</span>6</div>    <table summary="일,월,화,수,목,금,토 로 구성된 게시물 리스트">      <caption>2022.6 달력입니다.</caption>      <thead>        <tr>          <th class="sun" scope="col"><span>일</span></th>          <th class="mon" scope="col"><span>월</span></th>          <th class="tue" scope="col"><span>화</span></th>          <th class="wed" scope="col"><span>수</span></th>          <th class="thu" scope="col"><span>목</span></th>          <th class="fri" scope="col"><span>금</span></th>          <th class="sat" scope="col"><span>토</span></th>        </tr>      </thead>      <tbody>        <tr class="first"><td class="sun"><span>&nbsp;</span></td><td><span>&nbsp;</span></td><td><span>&nbsp;</span></td><td><span id="2022-06-01" class="rDate" title="예약가능일자"><a href="javascript:;">1</a></span></td><td><span id="2022-06-02" class="rDate" title="예약가능일자"><a href="javascript:;">2</a></span></td><td><span id="2022-06-03" class="rDate" title="예약가능일자"><a href="javascript:;">3</a></span></td><td class="sat"><span id="2022-06-04" class="rDate" title="예약가능일자"><a href="javascript:;">4</a></span></td>        </tr>        <tr><td class="sun"><span id="2022-06-05" class="rDate" title="예약가능일자"><a href="javascript:;">5</a></span></td><td><span id="2022-06-06" class="rDate" title="예약가능일자"><a href="javascript:;">6</a></span></td><td><span id="2022-06-07" class="rDate" title="예약가능일자"><a href="javascript:;">7</a></span></td><td><span id="2022-06-08" class="rDate" title="예약가능일자"><a href="javascript:;">8</a></span></td><td><span id="2022-06-09" class="rDate" title="예약가능일자"><a href="javascript:;">9</a></span></td><td><span id="2022-06-10" class="rDate" title="예약가능일자"><a href="javascript:;">10</a></span></td><td class="sat"><span id="2022-06-11" class="rDate" title="예약가능일자"><a href="javascript:;">11</a></span></td>        </tr>        <tr><td class="sun"><span id="2022-06-12" class="rDate" title="예약가능일자"><a href="javascript:;">12</a></span></td><td><span id="2022-06-13" class="rDate" title="예약가능일자"><a href="javascript:;">13</a></span></td><td><span id="2022-06-14" class="rDate" title="예약가능일자"><a href="javascript:;">14</a></span></td><td><span id="2022-06-15" class="rDate" title="예약가능일자"><a href="javascript:;">15</a></span></td><td><span id="2022-06-16" class="rDate" title="예약가능일자"><a href="javascript:;">16</a></span></td><td><span id="2022-06-17" class="rDate" title="예약가능일자"><a href="javascript:;">17</a></span></td><td class="sat"><span id="2022-06-18" class="rDate" title="예약가능일자"><a href="javascript:;">18</a></span></td>        </tr>        <tr><td class="sun"><span id="2022-06-19" class="rDate" title="예약가능일자"><a href="javascript:;">19</a></span></td><td><span id="2022-06-20" class="rDate" title="예약가능일자"><a href="javascript:;">20</a></span></td><td><span id="2022-06-21" class="rDate" title="예약가능일자"><a href="javascript:;">21</a></span></td><td><span id="2022-06-22" class="rDate" title="예약가능일자"><a href="javascript:;">22</a></span></td><td><span id="2022-06-23" class="rDate" title="예약가능일자"><a href="javascript:;">23</a></span></td><td><span id="2022-06-24" class="rDate" title="예약가능일자"><a href="javascript:;">24</a></span></td><td class="sat"><span id="2022-06-25" class="rDate" title="예약가능일자"><a href="javascript:;">25</a></span></td>        </tr>        <tr><td class="sun"><span id="2022-06-26" class="rDate" title="예약가능일자"><a href="javascript:;">26</a></span></td><td><span id="2022-06-27" class="rDate" title="예약가능일자"><a href="javascript:;">27</a></span></td><td><span id="2022-06-28" class="rDate" title="예약가능일자"><a href="javascript:;">28</a></span></td><td><span id="2022-06-29" class="rDate" title="예약가능일자"><a href="javascript:;">29</a></span></td><td><span id="2022-06-30" class="rDate" title="예약가능일자"><a href="javascript:;">30</a></span></td><td><span>&nbsp;</span></td><td class="sat"><span>&nbsp;</span></td>        </tr>        <tr class="last"><td class="sun"><span>&nbsp;</span></td><td><span>&nbsp;</span></td><td><span>&nbsp;</span></td><td><span>&nbsp;</span></td><td><span>&nbsp;</span></td><td><span>&nbsp;</span></td><td class="sat"><span>&nbsp;</span></td>        </tr>      </tbody>    </table></div><a class="btnCalNext" href="javascript:;">	<span>Next</span></a></div><div class="btnList"><a href="#none" class="btnSubmit">
					<img src="${pageContext.request.contextPath}/images/ko/mem/new_2019/reserve_step1_ok.gif" alt="확인"></a><a href="#none" class="btnSubmit" style="display:none"><img src="${pageContext.request.contextPath}/images/ko/mem/new_2019/reserve_step1_ok_disable.gif" alt="확인"></a><!--비활성화--></div></div>
					<div class="ly_reserve promotionCalendar new_rsvCal" id="promotionCalendar"></div>
					<div class="ly_reserve rsvPeople" style="display: none;" id="roomCntArea" tabindex="0">
						<div class="r_number">
		                ...
		                <ul class="notiList1">
		              	...
		              	<div class="btnList">
							<a href="#none" class="btnSubmit">
								<img src="${pageContext.request.contextPath}/images/ko/mem/new_2019/reserve_step1_ok.gif" alt="확인">
							</a>
		            	</div>
		            </div>
				</div>
					...
					<div class="rsvDescNone">
						예약 가능한 객실이 없습니다.<br>검색하신 호텔 주변에 다른 지점을 추천해드릴까요?<br>
							<a href="#none" class="btnRecommend" onclick="fnNearByHotels('ko');">
								<img src="${pageContext.request.contextPath}/images/ko/mem/new_2019/reserve_step1_recommend.gif" alt="호텔 추천 받기">
							</a>
						</div>
				</div>
				...
				<script>
	         	...
	         	<div class="rsvResultWrap" style="display: none;" id="rsvResultWrap">
	         		<div class="rsvResulTop" id="rsvResultTop" style="">
								...
								<ul class="rsvSort" id="rsvSort" style="">
									...
									<a href="#none" class="btnkeyword" title="키워드검색 닫기">키워드</a>
					           				<div class="keyWordWrap">
					            				<strong class="tit">
					            					<img src="${pageContext.request.contextPath}/images/ko/mem/new_2019/tit_rsv_keyword.gif" alt="키워드 검색">
					            				</strong>
					            				<div class="keyWordG">
						            				<span>
													...
													<a href="#none" class="btnKeySrch" onclick="fncSearchResvList('N');">
						                				<img src="${pageContext.request.contextPath}/images/ko/mem/new_2019/reserve_step1_keyword.gif" alt="적용">
						                			</a>
					              				</div>								 
											</div>
										</li>
									<li class="sort2" style="right: 0px;">
										<div class="sortSelect" style="">
											<div class="selector" id="uniform-sortBy" style="width: 114px;"><span style="width: 89px; user-select: none;">낮은 가격 순</span><select title="정렬순서 선택" id="sortBy" name="sortBy" onchange="fncSearchResvList('N');return false;" style="">
						...
						<div class="cloneEstCharge"></div><div class="estCharge" id="estCharge" style="display: none;">
							<div class="inner">
								<div class="estRsvTotal">
									<div class="totalPBox">
										<div class="totalP" id="totlO">
											<dl>
												<dt class="txtTotal2"><img src="${pageContext.request.contextPath}/images/ko/mem/new_2019/tit_est_totalprice4.png" alt="(부가가치세 포함)"></dt>
												<dd class="bPrice totlAmt"></dd>
											</dl>
										</div>
										<div class="totalP" id="totlC" style="display:none;">
											<dl>
												<dt class="txtTotal3"><img src="${pageContext.request.contextPath}/images/ko/mem/new_2019/tit_est_totalprice4.png" alt="총 예약 금액(부가가치세 포함)"></dt>
												<dd class="bPrice totlAmt"></dd>
											</dl>
										</div>
										<div class="btnStepN step1">
												<a href="#none" class="btnN option" onclick="goStep2('ko');"><img src="${pageContext.request.contextPath}/images/ko/mem/new_2019/btn_est_option.gif" alt="옵션선택"></a>
											</div>
									...
									<div class="inner">
										<div>
											<div class="detailRsvInfo">
												...
												<dl class="r_list1">
													<dt id="rsvInfoImg">
														<img src="${pageContext.request.contextPath}/images/ko/mem/new_2019/temp/dummy_hotel_200x113.jpg" alt="">
														<span></span>
													</dt>
													<dd>
														<ul>
										...
										<div class="detailRsvPrice">
											<h3 class="sTit"></h3>
											<a href="#none" class="btnRsvClear" onclick="clearResv();"><img src="${pageContext.request.contextPath}/images/ko/mem/new_2019/btn_rsvclear.png" alt="예약 초기화"></a>
											<div class="scroll">
			...
			<div id="comparePop" style="display:none">
				<div class="popLayer popLayerCompare2 new_popLayer" tabindex="-1">
					...
					<div class="popCtn new_rsvBox scroll" style="max-height: 649px;">
...
<div id="accViewPop" style="display:none">
	<div class="popLayer popLayererAccImgView">
		<div class="popHead">
			<h2 class="tit">
			<img alt="이미지보기 - 팝업" src="${pageContext.request.contextPath}/images/ko/mem/main/accImgViewTitle.gif"></h2>
...
<script type="text/javascript" id="">var prd_array=[],room_cnt=document.getElementById("tempRoomCnt").getAttribute("value");room_cnt=Number(room_cnt);for(var i=0;i<room_cnt;i++)prd_array.push({item_name:google_tag_manager["GTM-T3LBJ26"].macro(60),item_id:google_tag_manager["GTM-T3LBJ26"].macro(61)+"_Room"+(i+1),quantity:google_tag_manager["GTM-T3LBJ26"].macro(62)});var dataLayer=window.dataLayer||[];
window.dataLayer.push({event:"eec.list",hotel:google_tag_manager["GTM-T3LBJ26"].macro(63),checkInDate:google_tag_manager["GTM-T3LBJ26"].macro(64),checkOutDate:google_tag_manager["GTM-T3LBJ26"].macro(65),numberOfNights:google_tag_manager["GTM-T3LBJ26"].macro(66),timeDifference:google_tag_manager["GTM-T3LBJ26"].macro(67),numberOfRooms:google_tag_manager["GTM-T3LBJ26"].macro(68),numberOfGuests:google_tag_manager["GTM-T3LBJ26"].macro(69),ecommerce:{items:prd_array}});</script>
