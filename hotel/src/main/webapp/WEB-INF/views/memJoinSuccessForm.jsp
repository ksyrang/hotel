...
<meta name="description" content="가입완료"><!-- <meta name="keywords" content="신라리워즈 가입, 가입완료" /> -->
<meta name="og:title" content="가입완료 | 신라리워즈 가입 | The Shilla Hotels &amp; Resorts">
<!-- 검색엔진용 추가 180524 -->
...
<div class="container">
	<div class="contents" id="contents">
		<div class="ctnJoin ctnJoinStep3">
			<div class="location">
				<p class="list"><span class="crPosit">현재 페이지 위치 : </span>  &gt; <strong>신라리워즈 가입</strong></p>
			</div>
			<div class="myRewardsjoinTit">
				<h3 class="tit">신라리워즈 가입</h3>
			</div>
			
			<div class="joinStep">
				<ul class="step">
					<li class="t1 first"><span style="font-size: 0px;">약관동의</span></li>
					<li class="t2"><span style="font-size: 0px;">회원정보 입력</span></li>
					<li class="t3 on last"><span style="font-size: 0px;">약관동의</span></li>
				</ul>
			</div>
			<div class="top">
				<h3 class="tit">감사합니다</h3>
				<p class="info1">SEUNGHO CHOI님께서는 신라리워즈에 정상적으로 가입되셨습니다.</p>
			</div>
			...
			<!-- 추가 멤버십 박스 시작 -->
				<div class="goldBox bold3px">
					...
					<ul class="rewardsBox">
						...
						<li class="reWnum last">csh990121</li>
					</ul>
					<div class="glayBox">
			...
			<br>
			<div class="btnList">
				<a href="/login/memLogin.do" class="btnGoLogin">로그인</a>
			</div>
		</div>
	</div>
</div><div id="emailAdCollectPop" style="display:none"></div><div id="footerEmailLayer" style="display:none"></div><div class="foot footHub">
			<script type="text/javascript">
	function openIdInfo() {
