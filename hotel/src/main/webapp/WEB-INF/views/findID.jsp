...
</script></head><body class="subBody joinBody"><div id="popCalendarDiv" class="popCalendar" style="display:none"></div><link href="/css/mem/common.css" rel="stylesheet" type="text/css">
...
<form id="forIdForm" name="forIdForm" action="" method="POST">
<div class="popLayer popLayerFindId">
	...
	<div class="popCtn">
			...
			<div class="formBox">
				<table class="tableFormBox" summary="성명,이메일,휴대폰으로 구성된테이블입니다.">
					...
					<tbody><tr>
						...
						<td>
							<label for="rName1" class="rName1">first name </label>
							<input type="text" class="rName1 input uiform" id="mbrEnFnm" name="mbrEnFnm" placeholder="First name(이름)" style="text-transform: uppercase;" onkeyup="this.value=this.value.replace(/[^a-z]/gi,'');">
						
							<label for="rName2" class="rName2">Last name </label>
							<input type="text" class="rName2 input uiform" id="mbrEnLnm" name="mbrEnLnm" placeholder="Last name(성)" style="text-transform: uppercase;" onkeyup="this.value=this.value.replace(/[^a-z]/gi,'');">
					...
					<tr>
						...
						<td>
							<input id="email" name="email" class="emailId uiform text" type="text" style="width: 254px;">
		...
		<div class="step step3" style="display:none" id="step4Div">
			...
			<div class="btnList">
<a class="btnSubmit" href="javascript:popCloaeForId();"><span>닫기</span></a> 
			</div>
		</div>
		
	</div>
	<div class="btnAcc"><a class="btnClose" href="javascript:popCloaeForId();"><span>닫기</span></a></div>
</div>
</form>
