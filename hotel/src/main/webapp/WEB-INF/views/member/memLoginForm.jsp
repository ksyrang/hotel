					...
					<div class="cBox">
						<fieldset class="loginSet">
							<form id="f" action="${root }loginProc" method="POST">
								<div class="inputForm">
									<div style="float: left; height: 30px;"><input type="text" style="width: 280px; " name="memberId" placeholder="신라 리워즈 아이디 입력"></div>
									<div style="float: left;"><input type="password" style="width: 280px; " maxlength="40" name="memberPw" placeholder="비밀번호"></div>
								</div>
								<!-- 로그인 버튼 -->
								<div class="loginBtn">	
						...
						<div class="btn">
							<a class="btnJoin" href="${root }index?formpath=memberJoin"><span>신라리워즈 가입</span></a>
